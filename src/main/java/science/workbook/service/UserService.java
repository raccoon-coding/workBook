...
public class UserService {
    ...
    @Transactional
    public User createNewUser(GetNewUserDto controllerDto, EmailType emailType) {
        ...
        User newUser = new User(dto, emailType);
    ...
    public TokenDto loginUser(JoinUserDtoToService dto) {
        ...
        return jwtProvider.createToken(new CreateTokenDtoToService(user.getId(), 0));
    }
